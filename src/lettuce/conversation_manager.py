...
class UserConversation:
    ...
    def update_state(
        self, new_state: ConversationState, key: Optional[str] = None, value: Optional[str] = None
    ):
        ...
        "blocks": [
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": (
                        "👋 *Hi! I can help you find OWASP projects.*\n\n"
...
def get_mission_goal_message() -> dict:
    ...
    return {
        ...
        "blocks": [
            {"type": "section", "text": {"type": "mrkdwn", "text": "🎯 *What is your goal?*"}},
            {
                "type": "actions",
                "elements": [
                    {
